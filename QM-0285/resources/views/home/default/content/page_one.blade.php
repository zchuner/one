...
<div class="top">
    <div class="topMain"><img src="{asset('home/images/logo-s.png')}" name="logo" width="339" height="117" id="logo" alt="{$SEO['site_title']}" />
        <div class="topMain_right">
            <div class="topRight_title" ><!--style="text-align:center;font-size:32px;line-height:90px;color:#068dda;letter-spacing:24px;"-->
            <!--{$title}-->
            	<!--新增广告-->
    ...
    <div class="topNav" style="width:980px;background-size:100% 100%;">
        ...
        <ul>
            ...
            {loop $arrchild_arr $cid}
                <li{if $catid==$cid} class="cur"{/if} style="float:left;"><a href="{$CATEGORYS[$cid][url]}" target="_blank">{$CATEGORYS[$cid][catname]}</a></li>
            {/loop}
        </ul>
        {/qm}
    </div>
...
<div class="space"></div>
<div class="aboutus_main" style="width:980px;">
 ...
 <!--   <div class="aboutus_right">-->
        ...
        <div class="aboutus_rightMain" style="padding:0;width:980px;">
            {$content}
        </div>
   <!-- </div>-->
</div>
