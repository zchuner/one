...
function showADContent() {
  ...
  if (this.ADType == "images") {
	  for(var i=0;i<AD.Count;i++) {
		  ...
		  y = this.PaddingTop;
		  str += "<div id='PCMSAD_"+this.PosID+"_"+i+"' style='"+align_b+":0;top:25%;width:"+this.Width+"px; height:"+this.Height+"px; position: fixed;z-index:888888;'>";
		  if (AD.Images[i].imgADLinkUrl) str += "<a href='"+this.URL+"poster_click?siteid="+this.SiteID+"&id="+this.ADID+"&url="+AD.Images[i].imgADLinkUrl+"' target='_blank'>";
		  ...
		  str += "<div style='text-align:"+align+"'><a href='javascript:void(0);' onclick='javascript:document.getElementById(\"PCMSAD_"+this.PosID+"_"+i+"\").style.display=\"none\"'>关闭</a></div>";
		  str += "</div>";
  		  document.write(str);
	  }
