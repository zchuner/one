    ...
    <div class="hidden-xs container top">
        <div class="row">
            <div class="col-xs-4 logo">
                <h1><a href="<?php echo url('/'); ?>"><?php echo $SEO['site_title'];?></a></h1>
            </div>
        ...
        <div class="container" style="z-index:200;">
            <div class="row">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=df26edb7636bb500f0d1e2bf5e52c128&action=category&catid=0&num=30&siteid=%24siteid&order=listorder+ASC&return=TopNav\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = extendLoad::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$TopNav = $content_tag->category(array('catid'=>'0','siteid'=>$siteid,'order'=>'listorder ASC','limit'=>'30',));}?>
