            ...
            <div class="row "><!--新增 rowMT-->
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                     ...
                     <ul class="items nav navbar-nav row">
                     	<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=cd4b8ee8a9d3ba61a17005aaee289337&action=category&catid=%24catid&num=25&order=listorder+ASC&return=topNav\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = extendLoad::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$topNav = $content_tag->category(array('catid'=>$catid,'order'=>'listorder ASC','limit'=>'25',));}?>
                            <li class="item<?php echo (!isset($catid)) ? ' active' : ''?>"><a href="<?php echo url('/'); ?>">首页 <span class="sr-only">(current)</span></a></li>
                            <?php $n=1;if(is_array($topNav)) foreach($topNav AS $r) { ?>
                            <li class="itemNew"><a style="font-size:15px;color:#fff;" href="<?php echo $r['url'];?>" target="_blank"><?php echo $r['catname'];?></a></li>
                            <?php $n++;}unset($n); ?>
