...
class attachment
{
    ...
    function add($uploadedfile)
    {
        ...
        $uploadedfile['status'] = extendLoad::load_config('system', 'attachment_stat') ? 0 : 1;
    ...
    {
        file_put_contents(ROOT_PATH . 'xxx.txt', $id);
    }
