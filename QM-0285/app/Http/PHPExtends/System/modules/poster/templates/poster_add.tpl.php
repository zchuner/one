...
<form method="post" action="?m=poster&c=poster&a=add" id="myform">
    <table class="table_form" width="100%" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                <?php if($spaceid) { echo '<b style="color:#F60;">',$sinfo['name'],'</b>&nbsp;[',$TYPES[$sinfo['type']],']<input type="hidden" name="poster[spaceid]" value="'.$spaceid.'">'; } else {?><select name="poster[spaceid]" id="spaceid" onchange="AdsType(this.value)">
