        ...
        <div class="table-list">
                    ...
                    foreach($infos as $info){
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                | <a href="?m=poster&c=poster&a=add&spaceid=<?php echo $info['spaceid']?>&menuid=<?php echo $_GET['menuid']?>">添加广告</a>
                            </td>
                        </tr>
                        <?php
                    }
            ...
            <div class="content">
                <div class="btn-box">
                    ...
                    <input name="submit" type="submit" class="button" value="<?php echo L('remove_all_selected')?>" onClick="return confirm('<?php echo L('confirm', array('message' => L('selected')))?>')">&nbsp;&nbsp;
                </div>
            </div>
        </div>
