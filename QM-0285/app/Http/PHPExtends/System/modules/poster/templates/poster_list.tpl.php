        ...
        <div class="table-list">
                ...
                if(is_array($infos)){
                    foreach($infos as $info){
                        ...
                        <tr>
                            ...
                            <td align="center"><a href="?m=poster&c=poster&a=edit&id=<?php echo $info['id'];?>&menuid=<?php echo $_GET['menuid']?>" ><?php echo L('edit')?></a>|<a href="?m=poster&c=poster&a=stat&id=<?php echo $info['id']?>&spaceid=<?php echo $_GET['spaceid'];?>"><?php echo L('stat')?></a></td>
                        </tr>
                        <?php
                    }
                }
            ...
            <div class="content">
                <div class="btn-box">
                    ...
                    <input name="submit" type="submit" class="button" value="<?php echo L('delete')?>" onClick="document.myform.action='?m=poster&c=poster&a=delete';return confirm('<?php echo L('confirm', array('message' => L('selected')))?>')">&nbsp;&nbsp;
                </div>
            </div>
        </div>
