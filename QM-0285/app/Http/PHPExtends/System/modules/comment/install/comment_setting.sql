DROP TABLE IF EXISTS `qm_comment_setting`;
CREATE TABLE IF NOT EXISTS `qm_comment_setting` (
...
INSERT INTO `qm_comment_setting` (`siteid`, `guest`, `check`, `code`, `add_point`, `del_point`) VALUES (1, 0, 0, 0, 0, 0);