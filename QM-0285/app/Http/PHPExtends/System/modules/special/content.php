...
class content extends admin
{
    ...
    {
        parent::__construct();
        $this->db = extendLoad::load_model('special_content_model');
    ...
    public function add()
    {
        ...
        if ($_POST['dosubmit'] || $_POST['dosubmit_continue']) {
            ...
            $special_db = extendLoad::load_model('special_model');
    ...
    public function delete()
    {
        ...
        $special = extendLoad::load_model('special_model');
        $info = $special->get_one(array('id' => $specialid));
        $special_api = extendLoad::load_app_class('special_api', 'special');
    ...
    private function check($data = array(), $type = 'info', $action = 'add', $content = '')
    {
        if ($type == 'info') {
            ...
            if ($action == 'add') {
                ...
                $data['userid'] = session('admin')['userid'];
            }
        } elseif ($type == 'data') {
