                            ...
                            <td valign="top">
                                <div id="option_list">
                                    <?php if(is_array($types)) { $k = 1; foreach($types as $t) {?>
                                        <div class="mb6"><?php echo L('type_id')?>：<?php echo $t['typeid']?>&nbsp;&nbsp;</div>
                                        <div class="mb6">
                                                <?php echo L('type_name')?>：<input type="hidden" name="type[<?php echo $k?>][typeid]" value="<?php echo $t['typeid']?>" style="width:auto">
                                                <input type="text" name="type[<?php echo $k?>][name]" <?php if ($k==1) {?>id="type_name"<?php }?> value="<?php echo new_html_special_chars($t['name'])?>" class="input-text" size="15" style="width:auto">&nbsp;&nbsp;
                                                <?php echo L('type_path')?>：<input type="text" name="type[<?php echo $k?>][typedir]" <?php if ($k==1) {?>id="type_path"<?php }?> value="<?php echo $t['typedir']?>" class="input-text" size="15" style="width:auto">&nbsp;&nbsp;
                                                <?php echo L('listorder')?>：<input type="text" name="type[<?php echo $k?>][listorder]" value="<?php echo $t['listorder']?>" size="6" class="input-text" style="width:auto">
                                            <?php if ($k!=1) {?><a href="javascript:;" onclick="descItem(this, <?php echo $k?>);"><?php echo L('remove')?></a><?php }?>
                                        </div>
                                        <?php $k++; } }?>
                                </div>
                            </td>
...
<script type="text/javascript">
    ...
    function addItem() {
        ...
        var newOption =  '<div class="mb6"> <?php echo L('type_name')?>：&nbsp;<input type="text" name="type['+n+'][name]" class="input-text" size="15" style="width:auto">&nbsp;&nbsp;&nbsp;<?php echo L('type_path')?>：<input type="text" name="type['+n+'][typedir]" class="input-text" size="15" style="width:auto">&nbsp;&nbsp;&nbsp;<?php echo L('listorder')?>：<input type="text" name="type['+n+'][listorder]" value="'+n+'" size="6" class="input-text" style="width:auto">&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="descItem(this);"><?php echo L('remove')?></a></div>';
