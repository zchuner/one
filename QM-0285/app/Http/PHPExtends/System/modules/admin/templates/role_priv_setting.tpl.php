...
<div style="padding:6px 3px">
        ...
        <div id="site_list">
            <ul class="content role-memu" >
                <?php foreach($sites_list as $n=>$r) {?>
                    ...
                    <li><a href="?c=role&a=role_priv&siteid=<?php echo $r['siteid']?>&roleid=<?php echo $roleid?>" target="role"><span><img src="<?php echo IMG_PATH?>icon/gear_disable<?php echo $green?>.png" width="16" height="16" /><?php echo L('sys_setting');?></span><em><?php echo $r['name']?></em></a></li>
                <?php } ?>
            </ul>
        </div>
    </div>
    <div class="col-2 col-auto">
        <div class="content" style="padding:1px">
            <iframe name="role" id="role" src="?c=role&a=role_priv" frameborder="false" scrolling="auto" style="overflow-x:hidden;border:none" width="100%" height="483" allowtransparency="true"></iframe>
        </div>
    </div>
</div>
</body>
