            ...
            if (is_array($directory)){
                foreach ($directory as $d){
                    if (array_key_exists($d, $modules)) {
                        ...
                        if (file_exists(LOAD_PATH.'modules'.DIRECTORY_SEPARATOR.$d.DIRECTORY_SEPARATOR.'install'.DIRECTORY_SEPARATOR.'config.inc.php')) {
                            require LOAD_PATH.'modules'.DIRECTORY_SEPARATOR.$d.DIRECTORY_SEPARATOR.'install'.DIRECTORY_SEPARATOR.'config.inc.php';
                            $isinstall = L('install');
                        } else {
                            $module = L('unknown');
