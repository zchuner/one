...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#phpsso_api_url").formValidator({onshow:"<?php echo L('setting_phpsso_type')?>",onfocus:"<?php echo L('setting_phpsso_type')?>",tipcss:{width:'300px'},empty:false}).inputValidator({onerror:"<?php echo L('setting_phpsso_type')?>"}).regexValidator({regexp:"http|https:\/\/(.+)[^/]$",onerror:"<?php echo L('setting_phpsso_type')?>"});
    ...
    <div class="pad-10">
        <div class="col-tab">
                ...
                <table width="100%"  class="table_form">
                    <tr>
                        ...
                        <td class="y-bg">
                            ...
                            <input name="setconfig[phpsso]" value="0" type="radio"  <?php echo ($phpsso=='0') ? ' checked' : ''?>> <?php echo L('setting_no')?>
                        </td>
                    </tr>
                    <tr>
                ...
                <table width="100%"  class="table_form">
                    ...
                    <tr>
                        ...
                        <td class="y-bg">
                            ...
                            <input name="setting[mail_auth]" checkbox="mail_auth" value="0" type="radio" <?php echo $mail_auth==0 ? ' checked' : ''?>> <?php echo L('mail_auth_close')?>
                        </td>
                    </tr>
            ...
            <div id="div_setting_5" class="contentList pad-10 hidden">
                <table width="100%"  class="table_form">
                    <tr>
                        <th width="160"><?php echo L('setting_snda_enable')?></th>
                        <td class="y-bg">
                    ...
                    <tr>
                        ...
                        <td class="y-bg">
                            App ID  &nbsp;<input type="text" class="input-text" name="setconfig[wechat_app_id]" id="wechat_app_id" size="20" value="<?php echo $wechat_app_id;?>"/>
                            App secret <input type="text" class="input-text" name="setconfig[wechat_app_secret]" id="wechat_app_secret" size="40" value="<?php echo $wechat_app_secret;?>"/>
                            <a href="https://open.weixin.qq.com/" target="_blank"><?php echo L('click_register')?></a>
                        </td>
                    </tr>
                    <tr>
