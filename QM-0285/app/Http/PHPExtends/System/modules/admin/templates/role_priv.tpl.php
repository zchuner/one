...
<?php if($siteid) {?>
    <div class="table-list" id="load_priv">
        ...
        <form name="myform" action="?c=role&a=role_priv" method="post">
            <?php echo csrf_field()?>
...
<?php } else {?>
    <style type="text/css">
        .guery{background: url(<?php echo IMG_PATH?>msg_img/msg_bg.png) no-repeat 0 -560px;padding:10px 12px 10px 45px; font-size:14px; height:100px; line-height:96px}
