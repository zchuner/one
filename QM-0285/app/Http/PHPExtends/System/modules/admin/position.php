...
class position extends admin
{
    ...
    {
        parent::__construct();
        $this->db = extendLoad::load_model('position_model');
        $this->db_data = extendLoad::load_model('position_data_model');
        $this->db_content = extendLoad::load_model('content_model');
        $this->sites = extendLoad::load_app_class('sites');
    }
    ...
    public function add()
    {
        if (isset($_POST['dosubmit'])) {
            ...
            $this->sitemodel_db = extendLoad::load_model('sitemodel_model');
