 ...
 * @param string $old_tag 老PC标签
 * @param string $new_tag 新PC标签
...
function creat_template_bak($filepath, $style, $dir)
{
    ...
    $template_bak_db = extendLoad::load_model('template_bak_model');
...
/**
 * 生成标签选项
 * @param string $id HTML ID号
 * @param array $data 生成条件
 * @param string $value 当前值
 * @param string $op 操作名
 * @return string html 返回HTML代码
 */
