...
class file extends admin
{
    ...
    public function __construct()
    {
        ...
        $this->tpl_edit = extendLoad::load_config('system', 'tpl_edit');
        parent::__construct();
    }
    ...
    {
        $op_tag = extendLoad::load_app_class($_GET['op'] . "_tag", $_GET['op']);
    ...
    public function edit_pc_tag()
    {
        ...
        switch ($op) {
            ...
            case 'get':
                ...
                $dbsource_db = extendLoad::load_model('dbsource_model');
            ...
            default:
                ...
                $op_tag = extendLoad::load_app_class($op . "_tag", $op);
