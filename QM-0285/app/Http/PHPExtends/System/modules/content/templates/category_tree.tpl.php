...
<?php }?>
    <SCRIPT LANGUAGE="JavaScript">
        ...
        $(document).ready(function(){
            $("#category_tree").treeview({
                control: "#treecontrol",
                url: "<?php echo url('admin/extend?m=content&c=content&a=public_sub_categorys&menuid=' . $_GET['menuid'])?>",
                ajax: {
                    data: {
                        "additional": function() {
    ...
    <style type="text/css">
        ...
        .filetree .folder, .filetree .file{padding:1px 0 1px 20px;}
        #category_tree {padding-bottom: 100px;}
    </style>
    <div id="treecontrol">
...
if($_GET['from'] == 'block') {
    ...
    <ul class="filetree  treeview">
        <li class="collapsable">
            ...
            <span>
                <img src="<?php echo IMG_PATH.'icon/home.png';?>" width="15" height="14">&nbsp;
                <a href='?m=block&c=block_admin&a=public_visualization&type=index' target='right'><?php echo L('block_site_index');?></a>
            </span>
        </li>
    </ul>
<?php } else { ?>
    <ul class="filetree  treeview">
        <li class="collapsable">
            <div class="hitarea collapsable-hitarea"></div>
            <span>
                <img src="<?php echo IMG_PATH.'icon/box-exclaim.gif';?>" width="15" height="14">&nbsp;
                <a href='?m=content&c=content&a=public_checkall&menuid=822' target='right'><?php echo L('checkall_content');?></a>
            </span>
        </li>
    </ul>
<?php } echo $categorys; ?>