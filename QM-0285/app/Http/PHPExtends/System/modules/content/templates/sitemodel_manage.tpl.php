            ...
            foreach($datas as $r) {
                ...
                <tr>
                    ...
                    <td align='center'>
                        ...
                        <a href="javascript:;" onclick="model_delete(this, <?php echo $r['modelid']?>, '<?php echo L('confirm_delete_model',array('message'=>addslashes($tablename)));?>',<?php echo ($r['items']) ? $r['items'] : 0?>)"><?php echo L('delete')?></a> |
...
<script type="text/javascript">
    ...
    function edit(id, name) {
        ...
        window.top.art.dialog({
            ...
            id: 'edit',
            iframe: '<?php echo getExtendsUrl('?m=content&c=sitemodel&a=edit&modelid=')?>' + id,
            width: '580',
            height: '420'
        }, function () {
    ...
    function model_delete(obj, id, name, items) {
        ...
        window.top.art.dialog({content: name, fixed: true, style: 'confirm', id: 'model_delete'}, function () {
                $.get('?m=content&c=sitemodel&a=delete&modelid=' + id, function (data) {
                    if (data) {
