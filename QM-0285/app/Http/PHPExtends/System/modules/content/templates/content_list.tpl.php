                ...
                if(is_array($datas)) {
                    ...
                    foreach ($datas as $r) {
                        ...
                        <tr>
                            ...
                            <td align='center'>
                                <?php echo getNickname($r['username']); ?></td>
                            <td align='center'><?php echo format::date($r['updatetime'],1);?></td>
                            <td align='center'><?php echo format::date($r['inputtime'],1);?></td>
                            <td align='center'><a href="?m=content&c=content&a=edit&catid=<?php echo $catid;?>&id=<?php echo $r['id']?>"><?php echo L('edit');?></a> | <a href="javascript:view_comment('<?php echo urlencode($r['url']);?>','<?php echo safe_replace($r['title']);?>')"><?php echo L('comment');?></a></td>
                        </tr>
                    <?php }
                }
                ?>
...
<script type="text/javascript">
    ...
    function view_comment(id, name) {
        ...
        window.top.art.dialog({yesText:'<?php echo L('dialog_close');?>',title:'<?php echo L('view_comment');?>：'+name,id:'view_comment',iframe:'?m=comment&c=comment_admin&a=lists&url=' + encodeURIComponent(id),width:'800',height:'500'}, function(){window.top.art.dialog({id:'edit'}).close()});
    }
