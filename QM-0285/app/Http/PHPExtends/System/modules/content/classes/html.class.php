...
class html
{
    private $siteid, $url, $html_root, $queue, $categorys, $page_db;
    ...
    public function __construct()
    {
        ...
        $this->html_root = extendLoad::load_config('system', 'html_root');
    ...
    public function category($catid, $page = 0)
    {
        ...
        if ($create_to_html_root) {
            if ($this->siteid == 1) {
                $file = ROOT_PATH . $base_file;
            } else {
                $file = ROOT_PATH . substr($this->html_root, 1) . $base_file;
            }
            //添加到发布点队列
