...
class manage extends admin
{
    ...
    function __construct()
    {
        ...
        $this->db = extendLoad::load_model('attachment_model');
        $this->attachment = extendLoad::load_sys_class('attachment');
    ...
    public function dir()
    {
        ...
        $local = str_replace(array(ROOT_PATH, ROOT_PATH, DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR), array('', '', DIRECTORY_SEPARATOR), $filepath);
        //$show_header = true;
    ...
    public function pulic_dirmode_del()
    {
        ...
        $tmpdir = ROOT_PATH . $tmpdirs[0] . '/';
        if ($tmpdir != $this->upload_path) {
            showmessage(L('illegal_operation'));
        }
        $file = ROOT_PATH . $dir . DIRECTORY_SEPARATOR . $filename;
    ...
    {
        $aid = $_GET['aid'];
        $attachment_index = extendLoad::load_model('attachment_index_model');
