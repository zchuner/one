...
<script type="text/javascript">
    ...
    function album_cancel(obj,id,source){
        ...
        if($(obj).hasClass('on')){
            ...
            var strs = filenames = '';
            $.get('?m=attachment&c=attachments&a=swfupload_json_del&aid='+id+'&src='+source+'&filename='+filename);
            ...
            $(obj).addClass("on");
            $.get('?m=attachment&c=attachments&a=swfupload_json&aid='+id+'&src='+source+'&filename='+filename);
