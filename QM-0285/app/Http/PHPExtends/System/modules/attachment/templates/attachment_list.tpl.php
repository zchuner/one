                ...
                if(is_array($infos)){
                    foreach($infos as $info){
                        ...
                        <tr>
                            ...
                            <td width="20%"><img src="<?php echo file_icon($info['filename'],'gif')?>" /> <?php echo $info['filename']?> <?php echo $thumb ? '<img title="'.L('att_thumb_manage').'" src="' . IMG_PATH . 'admin_img/havthumb.png" onclick="showthumb('.$info['aid'].', \''.new_addslashes($info['filename']).'\')"/>':''?> <?php echo $info['status'] ? '<img src="' . IMG_PATH . 'admin_img/link.png"':''?></td>
