...
<div class="pad-lr-10">
    ...
    <form action="?m=attachment&c=address&a=update" method="post" onsubmit="return confirm('<?php echo L('form_submit_confirm');?>')">
        <table width="100%"  class="table_form">
            <tr>
                <th width="100"><?php echo L('old_attachment_address')?>：</th>
                <td class="y-bg"><input type="text" class="input-text" name="old_attachment_path" id="old_attachment_path" size="40" value="<?php echo UPLOAD_URL?>" /> <?php echo L('old_attachment_address_msg')?></td>
            </tr>
            <tr>
