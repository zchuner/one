...
$LANG['main_safety_permissions'] = '※ 建议您将System目录设置为755（linux）或只读（windows）';
...
$LANG['create_to_rootdir_tips'] = '当设置了html_root 时，将生成到该目录';
...
$LANG['site_domain_ex'] = '请填写域名';
$LANG['site_domain_ex2'] = '格式应该为http://www.baidu.cn/，请以‘/’结束';
...
$LANG['site_att_watermark_img_desc'] = '水印存放路径: images/water';
...
$LANG['modelid_edit_tips'] = ' <img src="' . asset('admin/extends/images/icon/help.gif') . '" title="当该栏目下数据为 0 时，可更换模型">';
