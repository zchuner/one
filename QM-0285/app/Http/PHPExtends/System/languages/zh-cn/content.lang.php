...
$LANG['admin_content_edit'] = '后台信息编辑模板：';
$LANG['admin_content_add'] = '后台信息添加模板：';
$LANG['member_content_add'] = '会员中心信息添加模板：';
$LANG['clear_data_message'] = '一、初始化数据已经清理完毕，请执行“更新栏目缓存”及“更新缓存”操作！<br />二、初始化数据已经备份到bakup/default/下面';
